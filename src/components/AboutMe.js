  ...
  return (
    <div className="container">
      ...
      <div className="content has-text-left">
        <p>
          Born in 1988 to American parents on a military base in Massachusetts, Timothy Barnaby, the youngest of four children, spent much of their childhood in solitude, creating and dreaming. Theose solitary moments of their childhood became the perfect training ground for reflection, allowing them to sit with their work, question it, and explore its deeper meaning.
        </p>
        <p>
          A self-trained artist, Timothy first fell in love with ceramics as a teenager. Later, they found a home as an art model for the Gage Academy of Art. This experience fueled their drive to explore the human figure in a broader sense. Timothy’s passion for self-portraiture and self-referential imagery emerged from a desire to evoke the raw and accessible human experience.
        </p>
        <p>
          During their time as a model at the Gage Academy, Timothy gained invaluable insights into the expression of light on the human form by sitting in on masterclasses. Techniques traditionally locked behind paywalls and taught only by masters became a part of their daily life, allowing them to internalize and apply these lessons in their own work.
        </p>
        <p>
